						...
						<div class="card mb-0">
							<div class="card-body">
								<div class="p-4">
									...
									<div class="form-body">
										<form class="row g-3" action="sign-in.php" method="POST">
											<div class="col-12">
												<label for="inputEmailAddress" class="form-label">Email</label>
												<input type="email" class="form-control" name="email" id="inputEmailAddress"  placeholder="Enter Email" require>
											</div>
											<div class="col-12">
											...
											<div class="col-12">
												<div class="text-center ">
                                                    ...
                                                    <p class="mb-0">Forget Password? <a href="./forget.php">Reset here</a>
													</p>
												</div>
											</div>
										</form>
