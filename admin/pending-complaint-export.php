...
$headerStyle = [
    'font' => ['color' => ['rgb' => 'FF0000']], // RGB value for red is FF0000
];
...
header('Content-Disposition: attachment;filename="pending-complaint-report.xlsx"');
header('Cache-Control: max-age=0');

$writer = new Xlsx($spreadsheet);
$writer->save('./excel/pending-complaint-report.xlsx');
$writer->save('php://output');
exit;
